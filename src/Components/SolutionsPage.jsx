...
export default function SolutionsPage({ onBack, onLoginClick }) {
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', fontFamily: "'Inter', sans-serif", background: '#f8fafc' }}>
      ...
      <main style={{ flex: 1, padding: '80px 32px', maxWidth: 800, margin: '0 auto', width: '100%' }}>
        <div style={{ background: '#fff', padding: '48px', borderRadius: '16px', boxShadow: '0 10px 25px -5px rgba(0, 0, 0, 0.05)' }}>
          <h1 style={{ fontSize: '3rem', fontWeight: 900, color: '#0f172a', marginBottom: 24, letterSpacing: '-0.02em' }}>Solutions</h1>
          ...
          <p style={{ fontSize: '1.15rem', color: '#475569', lineHeight: 1.7, marginBottom: 24 }}>
            Whether you are a small startup or a global enterprise, SmartPayroll scales with your business. We offer tailored solutions for employing contractors, full-time EOR employees, and managing direct employees internationally.
          </p>
